    ...
    function DecodeElsysPayload(data) {
        ...
        for (i = 0; i < data.length; i++) {
            ...
            case TYPE_VDD: //Battery level
                obj.battery = {value: ((data[i + 1] << 8) | (data[i + 2])) / 1000};
                i += 2;
                break
            ...
            case TYPE_PULSE1_ABS: //Pulse input 1 absolute value
                ...
                obj.pulse_count_abs = {value: pulseAbs};
                i += 4;
                break
            ...
            case TYPE_SOUND: //Sound
                ...
                obj.soundAverage = {value: data[i + 2]};
                i += 2;
                break
            ...
            case TYPE_EXT_DIGITAL2: //Digital input 2
                ...
                raw_value = (data[i + 1]);
                if (raw_value == 0) {
                    obj.digital2_binary = {value: "false"};
                } else if (raw_value == 1) {
                    obj.digital2_binary = {value: "true"};
                }
                i += 1;
                break
