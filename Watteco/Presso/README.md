...
[Technical Documentation](https://support.nke-watteco.com/presso-3/)  

## Assets

| Name                 | Title | Type   | Kind   | Unit |
|----------------------|-------|--------|--------|------|
| 4-20mA               | 4-20mA Input | Number | Sensor | mA |
...
## Example Payloads
`310A000C00553900000000`  
`110A005000064107010500000E5404`  
`310A000C00553900000000`  
`310A000C00553900000000`  