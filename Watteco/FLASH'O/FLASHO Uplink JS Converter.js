            ...
            if (decodedBatch === false) {
                ...
                if ((cmdID === 0x0a) | (cmdID === 0x8a) | (cmdID === 0x01)) {
                    ...
                    if ((clusterdID === 0x8004) & (attributID === 0x0000)) {
                        ...
                        att.MessageType = stdData.message_type;
                    }
                ...
                var decoded = {};
                brData = (brUncompress(4, [{ taglbl: 0, resol: 1, sampletype: 10, lblname: "Index1", divide: 1 }, { taglbl: 6, resol: 100, sampletype: 6, lblname: "BatteryVoltage", divide: 1000 }], lora.payload, lDate))
